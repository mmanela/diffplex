...
public class ThreeWayDiffResult(
    IReadOnlyList<string> piecesBase,
    IReadOnlyList<string> piecesOld,
    IReadOnlyList<string> piecesNew,
    IList<ThreeWayDiffBlock> blocks)
{
    /// <summary>
    /// The chunked pieces of the base text
    /// </summary>
    public IReadOnlyList<string> PiecesBase { get; } = piecesBase;
    ...
    /// </summary>
    public IList<ThreeWayDiffBlock> DiffBlocks { get; } = blocks;
}
